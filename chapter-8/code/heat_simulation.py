...
class HeatAnimator:
    ...
    def setup_plot(self):
        ...
        self.im = self.ax.imshow(initial_slice, cmap='hot', interpolation='bilinear',
    ...
    def create_animation(self, frames: int = 200, interval: int = 50):
        ...
        self.setup_plot()
        anim = animation.FuncAnimation(self.fig, self.animate_frame, frames=frames,
        ...
        if save_animation:
            ...
            if 'ffmpeg' in available_writers:
                try:
                    ...
                    anim.save('heat_equation_3d.mp4', writer='ffmpeg', fps=20, bitrate=1800)
                ...
                # Fallback to GIF
                try:
                    print("ffmpeg not available. Saving as GIF... (this may take a while)")
                    anim.save('heat_equation_3d.gif', writer='pillow', fps=10)
                    print("✓ Animation saved as heat_equation_3d.gif")
                except Exception as e:
